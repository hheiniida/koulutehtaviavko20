...
public class TiliSovellus {
	...
	private void teeOtto() {
		...
		if (this.tili.otto(maara)) {
			System.out.println("Tilin saldo oton j�lkeen " + this.tili.getSaldo());
		} else {
	...
	private void teePano() {
		...
		this.tili.pano(maara);
		
		
		System.out.println("Tilin saldo panon j�lkeen " + this.tili.getSaldo());
	}

	private void naytaTili() {
		System.out.println("Tilinumero: " + this.tili.getNumero());
		System.out.println("Saldo: " + this.tili.getSaldo());
		
		System.out.println("Omistajan nimi: " + this.tili.getOmistaja().getNimi());
	}
